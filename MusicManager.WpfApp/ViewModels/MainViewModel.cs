...
namespace MusicManager.WpfApp.ViewModels
{
    public class MainViewModel : BaseViewModel
    {
        ...
        {
            if (MessageBox.Show($"Удалить альбом '{SelectedAlbum!}'?", "Удалить", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
            {
        ...
        {
            if (MessageBox.Show($"Удалить трек '{SelectedTrack!}'?", "Удалить", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
            {
